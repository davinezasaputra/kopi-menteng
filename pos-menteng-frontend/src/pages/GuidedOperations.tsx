...
export default function GuidedOperations() {
  ...
  useEffect(() => {
    ...
    const loadMasters = async () => {
      ...
      try {
        const [supplierRes, customerRes, productRes, accountRes, orderRes, invoiceRes] = await Promise.all([
  ...
  const warehouseOptions: Option[] = warehouses.length ? warehouses : [{ id: '1', label: 'Warehouse aktif', meta: 'scope aktif' }];
