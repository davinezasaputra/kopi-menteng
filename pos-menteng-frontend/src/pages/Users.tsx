...
export default function Users() {
  ...
  const fetchUsers = async () => {
    ...
    try {
      ...
      setUsers(extractRows<UserRow>(response.data));
    } catch (error: any) {
      toast.error(error?.response?.data?.message || 'Gagal memuat data akun.');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleSave = async (event: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Akun karyawan berhasil ditambahkan.', { id: toastId });
      setShowModal(false);
      setFormData(emptyForm);
      await fetchUsers();
    } catch (error: any) {
      toast.error(error?.response?.data?.message || 'Gagal menambahkan akun karyawan.', { id: toastId });
    } finally {
      setSaving(false);
    }
  };
  ...
  const handleDelete = async (id: number | string) => {
    ...
    try {
      ...
      toast.success('Akun karyawan dinonaktifkan.');
      await fetchUsers();
    } catch (error: any) {
