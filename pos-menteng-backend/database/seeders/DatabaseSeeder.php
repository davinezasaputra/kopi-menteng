...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        User::updateOrCreate(['email'=>'kasir1@menteng.com'],[
            'name'=>'Kasir Satu','password'=>Hash::make(env('SEED_CASHIER_PASSWORD','change-me-immediately')),'role'=>'kasir','pin'=>env('SEED_CASHIER_PIN'),
        ]);
        $this->call([
