...
Route::middleware(['request.id','security.headers'])->group(function () {
    ...
    Route::middleware(['auth:sanctum','throttle:erp'])->group(function () {
        ...
        Route::middleware(['tenant','idempotency'])->group(function () {
            ...
            Route::post('/inventory/transfers', [InventoryTransferController::class, 'store'])->middleware('permission:inventory.stock.transfer');
            Route::get('/inventory/transfers', [InventoryTransferController::class, 'index'])->middleware('permission:inventory.stock.transfer');
            Route::post('/inventory/reservations', [InventoryReservationController::class, 'store'])->middleware('permission:inventory.stock.reserve');
            Route::get('/inventory/reservations', [InventoryReservationController::class, 'index'])->middleware('permission:inventory.stock.view');
            Route::post('/inventory/reservations/{reservation}/release', [InventoryReservationController::class, 'release'])->middleware('permission:inventory.stock.reserve');
            ...
            Route::post('/inventory/opnames/{opname}/snapshot', [InventoryOpnameController::class, 'snapshot'])->middleware('permission:inventory.stock.adjust');
