...
class CustomerPayment extends Model{
 ...
 protected $fillable=['id','tenant_id','company_id','branch_id','sales_invoice_id','customer_id','customer_name_snapshot','payment_number','payment_date','amount','method','reference','paid_by','request_id','notes'];
