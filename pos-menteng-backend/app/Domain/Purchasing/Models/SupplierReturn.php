...
{
    protected $fillable = [
        'tenant_id','company_id','branch_id','warehouse_id','supplier_id','purchase_order_id',
        'goods_receipt_id','return_number','return_date','status','created_by','request_id','reason','notes',
    ];

    protected function casts(): array { return ['return_date'=>'date']; }
